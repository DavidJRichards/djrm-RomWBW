...
Z180_IOWAIT	.SET	2		; Z180: I/O WAIT STATES TO ADD ABOVE 1 W/S BUILT-IN (0-3) ! djrm use 2(+1) for LCD
;
...
; djrm
;BOOT_TIMEOUT	.SET	2		; AUTO BOOT TIMEOUT IN SECONDS, -1 TO DISABLE, 0 FOR IMMEDIATE
;BOOT_DELAY	.SET	0		; FIXED BOOT DELAY IN SECONDS PRIOR TO CONSOLE OUTPUT
BOOTCON		.SET    0
;CRTACT          .SET    TRUE
CLCDENABLE	.SET	TRUE		; CLDC: ENABLE T6963 LCD VIDEO/KBD DRIVER (cldc.asm)
CLCDMODE	.SET	CLCDMODE_DJRM	; CLDC: DRIVER MODE: CLDCMODE_[NONE|DJRM] (wip)


MKYENABLE	.SET	FALSE		; MSX 5255 PPI KEYBOARD COMPATIBLE DRIVER (REQUIRES TMS VDA DRIVER)
VDAEMU_SERKBD	.SET	0 ;$FF		; VDA EMULATION: SERIAL KBD UNIT #, OR $FF FOR HW KBD
;
